# Example flake showing how to consume the auto-updated `kiro` package from
# another NixOS system or Home Manager configuration.
#
# Copy the relevant bits into your own flake.nix.
{
  description = "Example consumer of nixos-pkgs' kiro package";
  ...
  outputs =
    { nixpkgs, nixos-pkgs, ... }:
    {
        ...
        modules = [
          {
            ...
            environment.systemPackages = [
              # tracks the latest upstream kiro release automatically.
      ...
      #   modules = [
      #     {
      #       home.packages = [ nixos-pkgs.packages.x86_64-linux.kiro ];
      #     }
      #   ];
      # };
    };
